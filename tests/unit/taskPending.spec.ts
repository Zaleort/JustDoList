import TaskPendingModule from '../../src/store_modules/TaskPendingModule';

const mutations = TaskPendingModule.mutations;
...
describe('Task Pending Mutations', () => {
    ...
    it('Actualiza una subtarea a la Tarea Actual', () => {
        ...
        expect(state.current.subTasks[0]).toEqual(subTask);
    });
});
